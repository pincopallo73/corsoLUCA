...
rappresenta la connessione con il DB. Se non ci riesce non restituisce nulla
    ...
    Ovviamente deve esitere un DB "corsophp" sul server "127.0.0.1:3307", deve esistere un utente di nome "utentecorsophp" con password "password" (quando mi impegno riesco a creare password difficilissime)
...
$link = mysqli_connect("127.0.0.1:3307", "utentecorsophp", "password", "corsophp");
